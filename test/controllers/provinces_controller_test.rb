...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { city_id: @province.city_id, education_here_id: @province.education_here_id, job_here_id: @province.job_here_id, name: @province.name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { city_id: @province.city_id, education_here_id: @province.education_here_id, job_here_id: @province.job_here_id, name: @province.name } }
